...
#     name="LaBraM_finetune_no_pretrained",        
#     config={                      
...
example_epochs = pd.read_pickle(os.path.join("data", "FG_overview_df_v2.pkl"))
fif_files = glob.glob(os.path.join("data", "PreprocessedEEGData", "*_FG_preprocessed-epo.fif"))
example_fif = fif_files[0]
...
#     # Save model
torch.save(model.state_dict(), os.path.join(model_dir, "eeg_labram_model_no_pretrained.pth"))
